...
export function TradingViewIframe({
  ...
  return (
    ...
    >
      ...
      >
        <iframe
          src={`https://s.tradingview.com/widgetembed/?frameElementId=tradingview_${formattedSymbol}&symbol=${formattedSymbol}&interval=60&hidesidetoolbar=1&symboledit=1&saveimage=1&toolbarbg=${
            theme === "dark" ? "0e0f14" : "f1f3f6"
          }&studies=[]&theme=${theme}&style=1&timezone=Etc%2FUTC&locale=en&utm_source=&utm_medium=widget&utm_campaign=chart&utm_term=${formattedSymbol}`}
          style={{
            width: "100%",
            height: "100%",
            margin: "0",
