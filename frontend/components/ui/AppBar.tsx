...
export default function AppBar() {
    ...
    return (
      <div className="top-0 z-20 relative h-14 flex  justify-between p-3.5 w-full">
        {/*Logo and Types of Exchange  */}
        <div className="flex  justify-between items-center space-x-6">
          ...
          <Link href={"/"}>
            <div className="flex flex-row h-[24px] items-center gap-2.5">
              ...
              <svg
                className="translate-y-[1.6px] hidden sm:block"
                width="88.5"
                height="18"
                viewBox="0 0 118 24"
                fill="none"
          ...
          {/* Types */}
          <div className=" items-center justify-center flex-row flex gap-5 sm:mx-4 sm:gap-8">
            <Link
              onClick={() => {
